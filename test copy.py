...
# val_normal_json = list()
# val_outlier_json = list()
# dir_path = "./AD_json/"
# for json_file in os.listdir(dir_path):
#     if json_file.endswith("normal.json"):
#         val_normal_json.append(os.path.join(dir_path,json_file))
#     elif json_file.endswith("outlier.json"):
#         val_outlier_json.append(os.path.join(dir_path,json_file))

val_normal_json = ['/home/medical/Anomaly_Project/InCTRL/AD_json/pcb2_val_normal.json']
val_outlier_json = ['/home/medical/Anomaly_Project/InCTRL/AD_json/pcb2_val_outlier.json']
...
def parse_args():
    ...
    parser.add_argument("--category", type=str, default="pcb2", help="")
    parser.add_argument(
        "--shot", type=int, default=8, help="size for visual prompts"
    )
    parser.add_argument("--image_size", type=int, default=240, help="image size")
    parser.add_argument("--few_shot_dir", type=str, default="./fs_samples/visa/8/", help="path to few shot sample prompts")
